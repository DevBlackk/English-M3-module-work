...
// Adiciona a classe "clock" ao elemento do cronômetro
document.querySelector("#clock").classList.add("clock");

// Adiciona a classe "stopwatch" ao elemento do cronômetro
document.querySelector("#stopwatch").classList.add("stopwatch");

// Adiciona a classe "timer" ao elemento do cronômetro
